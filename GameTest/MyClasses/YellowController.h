#ifndef _YELLOWCONTROLLER_H_
#define _YELLOWCONTROLLER_H_

#include "SimpleAIController.h"

class YellowController : public SimpleAIController
{
public:
    YellowController(SimpleAIControlledGameObject* a_controlledGO);
    ~YellowController();
protected:
