#ifndef _GREENCONTROLLER_H_
#define _GREENCONTROLLER_H_

#include "SimpleAIController.h"

class GreenController : public SimpleAIController
{
public:
    GreenController(SimpleAIControlledGameObject* a_controlledGO);
    ~GreenController();
protected:
