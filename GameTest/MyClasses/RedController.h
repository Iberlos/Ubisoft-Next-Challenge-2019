#ifndef _REDCONTROLLER_H_
#define _REDCONTROLLER_H_

#include "SimpleAIController.h"

class RedController : public SimpleAIController
{
public:
    RedController(SimpleAIControlledGameObject* a_controlledGO);
    ~RedController();
protected:
