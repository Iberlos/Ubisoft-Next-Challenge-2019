#ifndef _MAGENTACONTROLLER_H_
#define _MAGENTACONTROLLER_H_

#include "SimpleAIController.h"

class MagentaController : public SimpleAIController
{
public:
    MagentaController(SimpleAIControlledGameObject* a_controlledGO);
    ~MagentaController();
protected:
