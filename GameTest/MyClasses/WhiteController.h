#ifndef _WHITECONTROLLER_H_
#define _WHITECONTROLLER_H_

#include "SimpleAIController.h"

class WhiteController : public SimpleAIController
{
public:
    WhiteController(SimpleAIControlledGameObject* a_controlledGO);
    ~WhiteController();
protected:
