#ifndef _CYANCONTROLLER_H_
#define _CYANCONTROLLER_H_

#include "SimpleAIController.h"

class CyanController : public SimpleAIController
{
public:
    CyanController(SimpleAIControlledGameObject* a_controlledGO);
    ~CyanController();
protected:
