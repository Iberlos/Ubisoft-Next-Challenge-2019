#ifndef _BLUECONTROLLER_H_
#define _BLUECONTROLLER_H_

#include "SimpleAIController.h"

class BlueController : public SimpleAIController
{
public:
    BlueController(SimpleAIControlledGameObject* a_controlledGO);
    ~BlueController();
protected:
