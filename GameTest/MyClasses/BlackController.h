#ifndef _BLACKCONTROLLER_H_
#define _BLACKCONTROLLER_H_

#include "SimpleAIController.h"

class BlackController : public SimpleAIController
{
public:
    BlackController(SimpleAIControlledGameObject* a_controlledGO);
    ~BlackController();
protected:
